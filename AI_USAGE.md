  ...
  Then I generated API Documentation and postman collection creation with gemini as well.
  
  
  Finally used the ai to generate test cases and create docker compose for this project
